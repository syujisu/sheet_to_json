 ...
 * @param jsonNode - json object to normalize
 * @param jsonSchema - json schema that describing target object format.
 * @param customConfig - normalization configuration parameters (see '/config/normalizer.js')
 * @returns {object}
 */
 ...
 * @param jsonNode - json object to convert
 ...
 * @param format - target field format, see 'formats.js'
 * @returns {object}
 */
const normalizePath = (jsonNode, paths, type, format = undefined) => {
  let jsonResult = { ...jsonNode };
